			...
			<div class="row" style="margin-top: 30px;margin-bottom: 20px;">
    			...
    			<div class="col l6 m12 s12">
    				<div id="error_message">
    					<div id="error_message_content" class="myCard"></div>
					</div>		
			...
			<script>
				$(document).ready(function(){
					...
					$("#submit").click(function(){
						...
						var e = $('#email').val();
						var url = 'other-student-any-semester-performance.php?year='+y+'&fall='+f+'&e='+e;
						...
						console.log(year);
						console.log(fall);
						if(year>0 && year<5 && (fall==0 || fall==1) && e!=''){
							$.ajax({
								type:"POST",
								url: "server/other_any_sem_grades.php",
								data:{
									year: year,
									fall: fall
								},
