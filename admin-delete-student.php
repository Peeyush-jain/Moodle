			...
			<div class="row" style="margin-top: 30px;margin-bottom: 20px;">
    			...
    			<div class="col l6 m12 s12 center">
    				...
    				<div class="myCard">
						...
						<input placeholder="Email of student" id="email" type="email" class="validate">
				...
				$(document).ready(function(){
					...
					$("#submit").click(function(){
						...
						if(email == ''){
							...
							$.ajax({
								type:"POST",
								url: "server/admin_delete_student.php",
								data:{
									email: email
								},
								success: function(result){
									...
									var element2 = document.getElementById('error_message_content');
									if(result['err']=='OK'){
										element2.innerHTML = 'Student Deleted succesfully';
									}
									else{
